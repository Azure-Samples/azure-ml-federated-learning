...
module workspace './modules/azureml/private_azureml_workspace.bicep' = {
  ...
  params: {
    ...
    machineLearningDescription: 'Azure ML demo workspace for federated learning (workspacePublicNetworkAccess=${workspacePublicNetworkAccess}, applyVNetPeering=${applyVNetPeering})'
...
// The DNS zone should have been created already during workspace provisioning above
...
module orchToSiloPrivateEndpoints './modules/networking/private_endpoint.bicep' = [for i in range(0, siloCount): {
...
resource privateDnsARecordOrchestratorStorage 'Microsoft.Network/privateDnsZones/A@2020-06-01' = {
