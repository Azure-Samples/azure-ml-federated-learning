...
// > az deployment group create --template-file .\mlops\bicep\open_sandbox_cpu_gpu_setup.bicep \
...
@description('The cpu VM used for creating compute clusters in orchestrator and silos.')
...
module silos './modules/fl_pairs/open_multiple_computes_storage.bicep' = [for i in range(0, siloCount): {
